...
const curriculumMenuButton = document.querySelector(".curriculumView");
const curriculumMenu = document.querySelector("#homeCurriculumMenu");
const curriculumExitMenu = document.querySelector("#back");

curriculumMenuButton.addEventListener("click",()=>{
    curriculumMenu.classList.add("open")
});
curriculumExitMenu.addEventListener("click",()=>{
    curriculumMenu.classList.remove("open")
});
